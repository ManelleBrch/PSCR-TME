...
public:
	...
	PixelJob(int x, int y,const Scene::screen_t & screen, const Scene & scene, Color * pixels, std::vector<Vec3D> & lights): x(x), y(y), screen(screen), scene(scene), pixels(pixels), lights(lights){}
